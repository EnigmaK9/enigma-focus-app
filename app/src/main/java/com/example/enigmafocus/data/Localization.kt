...
object AppStrings {
    ...
    private val enStrings = mapOf(
        ...
        "sleep_nudge_body" to "Sleep schedule is active (10:30 PM - 6:30 AM).\n\nNight screen usage disrupts melatonin and recovery.",
        "btn_sleep_lock" to "Turn off screen & Go to sleep",
        "btn_use_phone_1_min" to "Use phone for 1 minute",
        "btn_use_phone_1_min_wait" to "Use phone for 1 min (Wait %ds)",
    ...
    private val esStrings = mapOf(
        ...
        "btn_use_phone_1_min" to "Usar celular por 1 minuto",
        "btn_use_phone_1_min_wait" to "Usar celular 1 min (Espera %d s)",
        ...
        "language_desc" to "Selecciona el idioma de la aplicación (detecta el sistema automáticamente)",
        "lang_system" to "Automático (Sistema)",
