...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{textDark}{\nouppercase{\leftmark}}}
\fancyhead[R]{\small\textcolor{accentGreen}{\textbf{Enigma Focus}}}
...
% =========================================================================
\chapter[Introducción y Filosofía Unix]{Introducción, Filosofía Unix y Planteamiento del Problema}
...
\toprule
\textbf{Característica} & \textbf{Enigma Focus} & \textbf{OneSec} & \textbf{Opal / Freedom} & \textbf{Bienestar Digital} \\
\midrule
...
% =========================================================================
\chapter[Arquitectura y MVI/MVVM]{Arquitectura del Sistema, MVI/MVVM y Desacoplamiento Modular}
...
% =========================================================================
\chapter[Android Internals y Hardware]{Android Internals, Accesibilidad y Control de Hardware}
...
% =========================================================================
\chapter[Motor de Bloqueo y Watchdog]{El Motor de Bloqueo, Watchdog y Algoritmos Anti-Relapso}
...
% =========================================================================
\chapter[Interoperabilidad Unix y CLI]{Interoperabilidad Unix, CLI IPC y Configuración Declarativa}
...
\centering
\small
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash\ttfamily\footnotesize}p{5.2cm} >{\raggedright\arraybackslash\ttfamily\footnotesize}p{4.2cm} >{\raggedright\arraybackslash}X}
\toprule
\textbf{\textrm{\textbf{Acción del Intent}}} & \textbf{\textrm{\textbf{Parámetros Extra}}} & \textbf{\textrm{\textbf{Efecto en el Sistema}}} \\
\midrule
.action.START\_SESSION & --ei duration\_minutes 45 & Inicia sesión con cuenta regresiva y grises \\
.action.STOP\_SESSION & Ninguno & Detiene la sesión activa y restaura color \\
.action.TOGGLE\_GRAYSCALE & Ninguno & Alterna el modo monocromático en la GPU \\
.action.SET\_GRAYSCALE & --ez enabled true & Activa o desactiva la escala de grises \\
.action.SET\_ALWAYS\_BLOCK & --ez enabled true & Bloquea siempre las apps seleccionadas \\
.action.SET\_STRICT\_MODE & --ez enabled true & Bloquea sin permitir pausas de emergencia \\
.action.BLOCK\_PACKAGE & --es package <pkg> & Añade una aplicación a la lista negra \\
.action.UNBLOCK\_PACKAGE & --es package <pkg> & Elimina una app de la lista de bloqueo \\
.action.SET\_LANGUAGE & --es lang <en|es|system> & Cambia el idioma en tiempo de ejecución \\
.action.APPLY\_TEMPLATE & --es template <NOMBRE> & Aplica plantilla de horarios predefinida \\
.action.RELOAD\_CONFIG & Ninguno & Recarga en caliente la configuración desde disco \\
.action.EXPORT\_CONFIG & Ninguno & Exporta el JSON completo a la salida estándar \\
.action.GET\_STATUS & Ninguno & Devuelve el estado del motor en JSON \\
.action.CLEAR\_LOGS & Ninguno & Limpia el archivo de registros JSON Lines \\
\bottomrule
\end{tabularx}
...
% =========================================================================
\chapter[Internacionalización Dinámica]{Internacionalización (i18n) Dinámica y Detección del Sistema}
...
% =========================================================================
\chapter[Concurrencia y Rendimiento]{Concurrencia, Rendimiento y Supervivencia ante Optimizadores de Batería}
...
% =========================================================================
\chapter[Testing Automatizado]{Estrategia de Testing Automatizado y Pruebas de Estrés}
...
\centering
\small
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash\ttfamily}p{5.8cm} >{\raggedright\arraybackslash}X >{\centering\arraybackslash}p{2.6cm}}
\toprule
\textbf{\textrm{\textbf{Clase de Test}}} & \textbf{\textrm{\textbf{Objetivo Evaluado}}} & \textbf{\textrm{\textbf{Resultado}}} \\
\midrule
ComprehensiveFocusUnitTests & Intervalos de tiempo, cruces de medianoche, formateo bilingüe & \textbf{100\% Pass} \\
UnixArchitectureAndStressTests & Rejilla temporal de 24h (96 puntos), concurrencia en 16 hilos & \textbf{100\% Pass} \\
GrayscaleManagerTest & Permisos de ajustes seguros y comandos ADB & \textbf{100\% Pass} \\
AppInfoTest & Mapeo de entidades, filtrado de populares y flags de bloqueo & \textbf{100\% Pass} \\
MainScreenViewModelTest & Emisión de estados MVI, búsquedas reactivas y mutaciones & \textbf{100\% Pass} \\
\bottomrule
\end{tabularx}
...
% =========================================================================
\chapter[25 Preguntas STAR de Entrevista]{Banco Exhaustivo de 25 Preguntas de Entrevista Técnica Senior (STAR)}
...
% =========================================================================
\chapter[System Design Deep Dive]{Diseño de Sistemas Móviles a Gran Escala (System Design Deep Dive)}
...
% =========================================================================
\chapter[Ejercicios de Live Coding]{Catálogo de Ejercicios Prácticos de Live Coding para Entrevistas}
...
% =========================================================================
\chapter[Glosario y Comandos DevOps]{Glosario Técnico de Sistemas y Cheat Sheet de Comandos DevOps}
...
% =========================================================================
\chapter[Manual de Debugging y Profiling]{Manual de Debugging Avanzado, Profiling y Diagnóstico de Rendimiento}
...
% =========================================================================
\chapter[Seguridad y ProGuard]{Seguridad Móvil, Criptografía y Hardening de ProGuard/R8}
...
% =========================================================================
\chapter[Conclusiones y Estrategia]{Conclusiones y Recomendaciones Finales para el Candidato}
